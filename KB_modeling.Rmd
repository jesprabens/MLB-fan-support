...
playoff_success <- read.csv("MLB_Postseason_Success.csv")
...
#  Played in WC Play-In - Going to need to look up and manually add (Is this only the team that lost the wild card?)
#  Eliminated Round 1 - Going to need to look up and manually add
#  Eliminated Round 2 - Going to need to look up and manually add
#  Lost WS - LgWin but no WSwin
#  Won WS - WSWin 
```
