...
As seen in Figure 3a and 3b, the skew is too extreme to address with any common data 
...
fig4_dat %>%
  ...
  scale_y_discrete(expand = c(0,0), limits = factor(0:9)) +
  theme(
      # plot.title = element_text(face = "bold"),
        ...
        panel.border = element_rect(colour = "gray75", fill = NA),
        panel.background = element_rect(fill = "white")
        # plot.background = element_rect(fill = "darkorange")
  )
