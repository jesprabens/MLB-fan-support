...
\{\text{Mean google hits overall} \} + 
\gamma_0 \{\text{MLB google hits this month}\} + 
\gamma_{1} \{\text{Mean google hits last year}\} +
\gamma_{2} \{\text{Playoffs last year}\} +
\gamma_{3} \{\text{Win percent last year}\} +
\gamma_{4} \{\text{Attendance}\} +
...
While looking at the plot of the residuals of all three MLB teams, there are several important aspects to point out.  Beginning with the Cubs, it is evident that a majority of the residuals over these 16 years were larger than 0.  This means that our model typically underpredicted the Google hits of the Cubs.
