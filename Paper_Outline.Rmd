...
<<<<<<< HEAD
As mentioned, the data was quantile-normaized before construction of the model began.  We then proceeded by building a hierarchical model.  A hierarchicacal model consists of Considering the structure of our data, it made the most logical sense to split this hierarchical model into 3 levels.
...
The highest level of the model consists of variable
